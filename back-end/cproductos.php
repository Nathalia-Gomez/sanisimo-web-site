        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="dsoya.html">Soya</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="cbebida.html">Bebidas</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="egranola.html">Granola</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="icontacto.html">Contáctanos</a>
              </li>
              <li class="nav-item">
